...
// <script>
// import { Facebook, Twitter, Linkedin, Pinterest, Reddit, Telegram, WhatsApp, Email, Google } from "vue-socialmedia-share";
// export default {
//   name: "HelloWorld",
//   components: { Facebook, Twitter, Linkedin, Pinterest, Reddit, Telegram, WhatsApp, Email, Google },
//   props: {
//     shareUrl: String
//   },
//   data() {
